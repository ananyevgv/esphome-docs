...
substitutions:
  name: "basement-s3"
  lastname: APC
  device_description: "basement-controller"
...
#    apc_ups_id: ups0
#    quick_test:
#      name: "${lastname} quick_test"
#    deep_test:
#      name: "${lastname} deep_test"
#    ten_minutes_test:
#      name: "${lastname} ten_minutes_test"
...
text_sensor:
  ...
  - platform: apc_ups
    ...
    cause_of_last_transfer:
      ...
      filters:
        - substitute:
          - "R -> nacce table utility voltage rate of change" 
          - "S -> transfer due to U command or activation of UPS" 
...
# Reports the WiFi signal strength in %
  ...
  - platform: dht
    pin: 18
    temperature:
      name: "${name} server Temperature"
      id: room_t
    humidity:
      name: "${name} server Humidity"
    update_interval: 5s
    model: AM2302
